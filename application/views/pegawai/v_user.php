...
<div class="col-sm-offset-3 col-md-6 ">
  ...
  <div class="panel-heading">
    <h3 class="panel-title"><b><center>Form Tambah Data Pangkalan</center></b></h3>
  </div>
...
<form class="form-horizontal"  method="POST"  onSubmit="return validate()" action="<?php echo base_url() ?>index.php/kelola_user/insert">
  <div class="form-group">
    ...
    <div class="col-sm-7">
        ...
        <input type="hidden" id="hakakses" name="hakakses" class="form-control" value="pangkalan" readonly> Pangkalan 
     </div>
    </div>
  </div>
  <div class="form-group">
...
<form class="form-horizontal"  method="POST"  onSubmit="return validate()" action="<?php echo base_url() ?>index.php/kelola_user/insert">
  <div class="form-group">
    ...
    <div class="col-sm-7">
        ...
        <input type="hidden" id="hakakses" name="hakakses" class="form-control" value="pegawai" readonly> Pegawai
    </div>
    </div>
  </div>
  <div class="form-group">
